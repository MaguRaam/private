...
public:
    ...
    void initialize(FullMatrix<double>, FullMatrix<double>, bool); // Initialize the objetc - same as constructor 2
    void initialize(FullMatrix<double>, bool); // Least squares initializer 
